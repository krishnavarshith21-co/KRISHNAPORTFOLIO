  ...
  return (
    <section className="py-16 relative" aria-label="Currently Building">
      <div className="container-grid">
        <ScrollReveal>
          <div className="border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-8 md:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <span className="text-[9px] font-bold tracking-[0.2em] text-[var(--color-accent)] uppercase shrink-0">
              BUILDING
            </span>
          </div>
        </ScrollReveal>
